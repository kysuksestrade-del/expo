npx create-expo-app spaceman-predictor-ai
cd spaceman-predictor-ai
title: npx expo install react-native-reanimated react-native-svg
sidebar_title: eas build -p android --profile preview
